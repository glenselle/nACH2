...
describe('Validate', function(){
    describe('Required Fields', function(){
        it('required fields must have contents or an error is thrown', function(){
            var testObjectOne = {
                fieldOne: {
                    name: 'fieldOne',
                    width: 6,
    ...
    describe('Optional Fields', function(){
        it('optional fields can be left blank without throwing an error', function(){
            var testObjectOne = {
                fieldOne: {
                    name: 'fieldOne',
                    width: 6,
    ...
    describe('Lengths', function(){
        it('field values must not exceed their width (length) property', function(){
            var testObjectOne = {
                fieldOne: {
                    name: 'fieldOne',
                    width: 6,
    ...
    describe('Data Types (alpha)', function(){
        it('field values must correspond to the alpha data type', function(){
                var testObjectOne = {
                    fieldOne: {
                        name: 'fieldOne',
                        width: 10,
    ...
    describe('Data Types (alphanumeric)', function(){
        it('field values must correspond to the alphanumeric data type', function(){
                var testObjectOne = {
                    fieldOne: {
                        name: 'fieldOne',
                        width: 20,
